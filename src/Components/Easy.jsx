...
class Easy extends React.Component {
    render(){
        return(
            <div className="main" style={{width:"80vw", margin: "0 auto"}}>
                ...
                <p>Output: 5</p>
                <p>One more example: What value of val would make the code work? (2011 UILB Q17)</p>
...
System.out.print("\\nPHP");`}/>
                ...
                <p className="darkText lato">That alone is about 10/15 of the 40 questions on the exam. The rest of the ones in the "easy" section should
